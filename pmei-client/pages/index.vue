        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition flex flex-col items-center">
                    ...
                    <p class="text-gray-600 mb-4 text-center">Visualize as encomendas existentes, aceda às informações dos sensores e observe estatísticas sobre a PMEI</p>
                    <NuxtLink
                        to="/SGO"
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition flex flex-col items-center">
                    ...
                    <p class="text-gray-600 mb-4 text-center">Crie novas encomendas, ajuste rotas e visualize dados sobre o posicionamento global de entregadores</p>
                    <NuxtLink
                        to="/SDL"
                        class="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition flex flex-col items-center">
                    ...
                    <p class="text-gray-600 mb-4 text-center">Visualize, obtenha dados e verifique o estado das suas encomendas</p>
                    <NuxtLink
                        to="/SAC"
                        class="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">
